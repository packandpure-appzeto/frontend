                        ...
                        >
                            ...
                            <div className="p-6">
                                ...
                                <div className="space-y-3 mb-8">
                                    {issues.map((item, idx) => (
                                        <button key={idx} className="w-full flex items-center justify-between p-4 rounded-2xl border border-slate-100 hover:border-green-200 hover:bg-rose-50/50 transition-all group">
