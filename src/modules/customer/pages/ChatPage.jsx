                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-3">
                        <div className="relative">
                            ...
                            <div className="absolute bottom-0 right-0 h-3 w-3 bg-rose-500 rounded-full border-2 border-white animate-pulse"></div>
                        </div>
                        <div>
                            <h1 className="text-base font-black text-slate-800 leading-none">Support Chat</h1>
                            <p className="text-[10px] text-rose-600 font-bold mt-1 uppercase tracking-wider flex items-center gap-1">
                                <span className="h-1 w-1 bg-rose-500 rounded-full"></span> Online
                            </p>
                        </div>
                    </div>
                </div>
